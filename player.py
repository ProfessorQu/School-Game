...
class Player:
    ...
    def __init__(self):
        ...
        directory = "assets/Janco"

        for image_str in os.listdir(directory):
            image = pygame.image.load(directory + "/" + image_str).convert_alpha()
    ...
    def draw(self, screen: pygame.Surface):
        ...
        """
        screen.blit(self.images[0], utils.convert_to_screen(self.position) - Vector2(TILE_SIZE) / 2)
        # pygame.draw.circle(
        #     screen,
        #     [200, 10, 30],
